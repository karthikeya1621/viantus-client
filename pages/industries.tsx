...
import styles from "../styles/IndustriesPage.module.scss";
...
const IndustriesPage = () => {
  ...
  const { menu } = useMenu("IndustriesMenu");
  ...
  const fetchData = async () => {
    const { data } = await getPage("industries");
    if (data) {
  ...
  return (
    <div className={styles.industriespagecontainer}>
